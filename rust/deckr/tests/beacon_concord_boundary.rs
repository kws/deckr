use deckr::beacon::{find_candidates, BeaconAdvertiser};
use deckr::concord::{ConcordCoordinator, ContractState, ContractValidityStatus};
...
async fn withdrawing_beacon_advertisement_leaves_concord_contract_open() {
    ...
    let token_state = MemoryStateStore::new();

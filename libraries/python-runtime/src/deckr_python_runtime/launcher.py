...
from deckr_python_runtime.config import ConfigDocument, load_config_document
from deckr_python_runtime.lanes import LaneSubstrate
...
from deckr_python_runtime.util.anyio import add_signal_handler
...
async def run_document(
    ...
    async with anyio.create_task_group() as tg:
        ...
        tg.start_soon(run_until_done, name="deckr_python_runtime.launcher.runner")
        await anyio.sleep_forever()

...
if TYPE_CHECKING:
    from deckr.hw.events import HWDevice, HWSImageFormat
...
class CommandRouter:
    ...
    async def set_key_image(self, graph: Node | SubGraphNode) -> None:
        override = self._ensure_override(self._store.state_index)
